...
| `AWS_API_MCP_SSL_CERTFILE`                                        | ❌ No                       | -                                                        | Path to the TLS/SSL certificate file (PEM format) for HTTPS. When set together with `AWS_API_MCP_SSL_KEYFILE`, the server will serve over HTTPS instead of HTTP. Only used when `AWS_API_MCP_TRANSPORT` is set to `"streamable-http"`. Strongly recommended when binding to a non-loopback address.                                                                                                                                                                                                                                                                                                                          |
| `AWS_API_MCP_SSL_KEYFILE`                                         | ❌ No                       | -                                                        | Path to the TLS/SSL private key file (PEM format) for HTTPS. Must be set together with `AWS_API_MCP_SSL_CERTFILE`. Only used when `AWS_API_MCP_TRANSPORT` is set to `"streamable-http"`.                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `AWS_API_MCP_SSL_CA_CERTS`                                        | ❌ No                       | -                                                        | Path to the CA certificates file (PEM format) for mutual TLS (mTLS) client authentication. Only used when `AWS_API_MCP_TRANSPORT` is set to `"streamable-http"` and TLS is enabled via `AWS_API_MCP_SSL_CERTFILE` and `AWS_API_MCP_SSL_KEYFILE`.                                                                                                                                                                                                                                                                                                                                                                             |
